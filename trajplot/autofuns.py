...
def icheck( tt , path_movies = '' , path_datasets = '' , path_movie = '' , r = 7 , cmap = 'gray' , path_output = './' , marker = 's' , markersize = 25 , offset = ( 0 , 0 ) ) :
	"""
	...
	def GUI_plot( tt , df , ms = markersize , marker = marker , offset = offset ) : # show the frame
